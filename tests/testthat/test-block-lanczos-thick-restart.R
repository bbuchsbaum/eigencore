test_that("native block thick-restart candidate restarts and locks separated pairs", {
  set.seed(7)
...
test_that("native block thick-restart candidate locks on certificate scale and executes planned controls", {
...
test_that("native block thick-restart candidate supports sparse CSC without densifying", {
...
test_that("native block thick-restart candidate residuals match direct operator certificate", {
  n <- 120L
  A <- Matrix::bandSparse(
    n,
    k = c(-1, 0, 1),
...
test_that("native block thick-restart candidate agrees with R oracle on clustered subspaces", {
...
test_that("native block thick-restart candidate preserves target taxonomy", {
...
test_that("native block thick-restart candidate handles repeated wanted clusters when block covers multiplicity", {
...
test_that("native block thick-restart candidate rejects duplicate locked vectors", {
...
test_that("native block candidate uses dense full-subspace path when max_subspace spans n", {
