...
Use `generalized_svd(A, B)` for real dense GSVD workloads. The result exposes
homogeneous generalized singular values through `alpha_beta()`, orthogonal
factors `U`, `V`, and `Q`, and reconstructable `D1`, `D2`, `R`, and `zero_R`
factors.
...
Complex and sparse GSVD inputs remain future scope and fail explicitly rather
than routing through a dense or external-package fallback.
