...
|:---|:---|:---|---:|---:|---:|---:|:---|:---|:---|
| dense Hermitian | eigen | eigencore | 4.7930 | 1.06700 | 0 | 0 | TRUE | native dense Hermitian LAPACK fallback | ok |
| dense Hermitian | eigen | RSpectra | 0.4647 | 0.06661 | 0 | 0 | TRUE | NA | ok |
| dense Hermitian | eigen | base | 1.9850 | 0.42400 | 0 | 0 | TRUE | NA | ok |
| sparse path Laplacian | eigen | eigencore | 2.5630 | 1.83600 | 0 | 0 | TRUE | native tridiagonal Hermitian shift-invert (factorized Lanczos) | ok |
| sparse path Laplacian | eigen | RSpectra | 8.1660 | 0.01991 | 0 | 0 | TRUE | NA | ok |
| sparse path Laplacian | eigen | base | 13.6600 | 3.18800 | 0 | 0 | TRUE | NA | ok |
| dense low-rank SVD | SVD | eigencore | 1.6850 | 1.30600 | 0 | 0 | TRUE | native certified Gram SVD special case | ok |
| dense low-rank SVD | SVD | RSpectra | 0.2308 | 0.09405 | 0 | 0 | TRUE | NA | ok |
| dense low-rank SVD | SVD | irlba | 0.3618 | 0.56060 | 0 | 0 | TRUE | NA | ok |
| dense low-rank SVD | SVD | base | 1.6430 | 0.59420 | 0 | 0 | TRUE | NA | ok |
| tall sparse SVD | SVD | eigencore | 0.6963 | 0.01904 | 0 | 0 | TRUE | native certified Gram SVD special case | ok |
| tall sparse SVD | SVD | RSpectra | 0.4058 | 0.02502 | 0 | 0 | TRUE | NA | ok |
| tall sparse SVD | SVD | irlba | 0.7675 | 0.17600 | 0 | 0 | TRUE | NA | ok |
| tall sparse SVD | SVD | base | 1.8490 | 0.89790 | 0 | 0 | TRUE | NA | ok |
| wide sparse SVD | SVD | eigencore | 0.5477 | 0.02358 | 0 | 0 | TRUE | native certified Gram SVD special case | ok |
| wide sparse SVD | SVD | RSpectra | 0.4703 | 0.02246 | 0 | 0 | TRUE | NA | ok |
| wide sparse SVD | SVD | irlba | 1.0330 | 0.15420 | 0 | 0 | TRUE | NA | ok |
| wide sparse SVD | SVD | base | 2.7710 | 0.90980 | 0 | 0 | TRUE | NA | ok |
