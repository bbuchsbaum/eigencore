...
#>   restart: lobpcg 
#>   locked: 5 
#>   max residual: 1.747869e-08 
#>   max backward error: 1.30291e-10 
#>   max orthogonality loss: 9.992007e-16 
...
- The package reference, organised by topic, lives in the [reference
  index](https://bbuchsbaum.github.io/eigencore/reference/index.md).
