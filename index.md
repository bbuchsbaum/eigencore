...
_(R 4.5.1 · aarch64-apple-darwin20 · RSpectra 0.16.2 / irlba 2.3.7 / PRIMME 3.2.6. The SVD rows also allocate ~6–8× less memory than irlba. Rerun the script for numbers on your machine and BLAS.)

_(¹ RSpectra’s default mode (`which = "SA"`) returns 0 of 8 eigenvalues on this matrix after 2.7 s. Its shift-invert mode (`sigma = 0`) solves it in 13 ms — faster than eigencore — if you know to reach for it. eigencore picks the method itself and certifies the result.)
...
dense generalized eigen/QZ/GSVD compatibility work through
